...
CLASS_SKILL_REFERENCES: tuple[SkillReference, ...] = (
    ...
    class_skill("奥灵使", "奥灵系仪式", 1, "可启动隶属于已结契奥灵领域的仪式，使用【WLP+WLP】施法检定。", "奥术仪式"),
    ...
    class_skill("拟兽使", "拟兽系仪式", 1, "可启动拟兽学派仪式；习得时选择【INS+WLP】或【MIG+WLP】作为拟兽仪式检定。", "仪式嵌合术"),
    ...
    class_skill("元素使", "元素系仪式", 1, "可执行元素领域仪式，通常使用【INS+WLP】。", "仪式元素术"),
    ...
    class_skill("熵术士", "熵系仪式", 1, "可执行熵系领域仪式，通常使用【INS+WLP】。", "熵系仪式术"),
    ...
    class_skill("怒焰斗士", "挑衅", 5, "用行动消耗 5 MP，对可见生物进行【MIG+WLP】对抗并获得 +SL；成功则施加激怒，并迫使目标尽量把你纳入攻击或攻击性法术目标。", "嘲讽"),
    ...
    class_skill("守护者", "双盾战士", 1, "可在主手装备盾牌；装备双盾时同时获得两面盾增益，并可视为【MIG+MIG】【HR+5】物理双手格斗武器，额外造成防御精通 SL 伤害。", "双重盾牌"),
    ...
    class_skill("博学家", "知识就是力量", 1, "当你使用【INS+INS】进行开放检定时，本次检定获得 +SL；仅对开放检定有效。"),
    ...
    class_skill("游说家", "谴责", 6, "用行动消耗 5 MP，对能理解你言语的敌人进行【INS+WLP】对抗并获得 +SL；成功则目标失去 SL×10 MP，受到眩晕或动摇，且直到你下回合开始，任何伤害来源对其额外造成 SL 点伤害。"),
    ...
    class_skill("浪客", "窃取灵魂", 5, "冲突中用行动对可见生物执行【DEX+WLP】检定，DL 为目标魔防，检定 +SL；成功时小兵让你恢复 SL IP，精英/悍将给予价值上限为等级×30Z（反派×50Z）的灵魂宝藏；每个生物最多被成功窃取一次。", "灵魂窃取"),
    ...
    class_skill("御魂使", "御魂系仪式", 1, "可执行灵魂领域仪式，通常使用【INS+WLP】。", "仪式灵师术", "仪式御魂使术"),
...
HERO_SKILL_REFERENCES: tuple[SkillReference, ...] = (
    hero_skill("灵巧双手", "可用不同类型武器进行双武器战斗。", "灵活双持"),
    hero_skill("额外HP", "立即提高最大 HP；40 级后提升幅度更高。", "额外生命值"),
    hero_skill("额外MP", "立即提高最大 MP；40 级后提升幅度更高。", "额外精神值"),
    hero_skill("额外IP", "最大库存点 +4。", "额外物资点"),
    hero_skill("额外咒语", "额外学习两个同列表法术。", "额外法术"),
    hero_skill("背水", "暗刃骑士精通；异常状态会反过来强化检定和伤害。", "绝处逢生", class_name="暗刃骑士"),
    hero_skill("薄情者", "暗刃骑士精通；牺牲当前 HP，对有羁绊的唯一目标造成爆发伤害。", "摧心重击", class_name="暗刃骑士"),
    hero_skill("奥术回响", "奥灵使精通；奥灵领域适用时，额外推进或清除命刻。", "奥灵共鸣", class_name="奥灵使"),
    hero_skill("启示", "奥灵使精通；与自创未知奥灵结契，并可强化其遣散效果。", "奥灵启示", class_name="奥灵使"),
    hero_skill("嵌合术精通", "拟兽使精通；可从新的生物类型学习法术，并增加记忆槽。", "拟兽系精通", class_name="拟兽使"),
    hero_skill("彗星", "熵术士精通；学习究极熵系法术。", class_name="熵术士"),
    hero_skill("大口袋", "造物使精通；使用库存点时消耗减少。", "深藏不露", class_name="造物使"),
    hero_skill("升级", "造物使精通；休息时改造装备品质。", "技术升级", class_name="造物使"),
    hero_skill("卸甲真言", "游说家精通；说服动摇或危机中的小兵和平离开冲突。", "缴械雄辩", class_name="游说家"),
    hero_skill("重唱", "游说家精通；谴责或鼓舞后可再次使用同技能。", "复诵", class_name="游说家"),
    hero_skill("英雄级同伴", "旅人精通且拥有忠实伙伴；强化伙伴。", "英勇伙伴", class_name="旅人"),
    hero_skill("状态免疫", "旅人精通；选择一种异常状态完全免疫。", "免于异常", class_name="旅人"),
    hero_skill("希望", "御魂使精通；学习让已投降 PC 重燃希望的究极法术。", "重燃希望", class_name="御魂使"),
    hero_skill("数学魔法", "博学家精通；按属性骰尺寸把单体法术扩展为群体法术。", class_name="博学家"),
    hero_skill("我算到了", "博学家精通；预测敌人行动并提高其行动成本。", "不出所料", "不出所料！", class_name="博学家"),
    hero_skill("强力射击", "神射手精通；远程攻击造成额外伤害。", class_name="神射手"),
    hero_skill("完美瞄准", "神射手精通且拥有威慑射击；威慑射击可选择两个效果。", class_name="神射手"),
    hero_skill("劫掠", "浪客精通且拥有窃取灵魂；可对多个生物使用窃取灵魂。", "洗劫一空", class_name="浪客"),
    hero_skill("消失", "浪客精通；命中后消耗物语点，让目标暂时无法看见你。", "影逝", class_name="浪客"),
    hero_skill("灵猴握", "怒焰斗士精通；可单手装备部分双手武器。", "猴式握法", class_name="怒焰斗士"),
    hero_skill("强力攻击", "怒焰斗士或武器大师精通；近战攻击造成额外伤害。", "猛力打击", class_name="怒焰斗士/武器大师"),
    hero_skill("堡垒", "守护者精通；冲突第一轮获得全伤害抵抗和异常抗性。", "坚强壁垒", class_name="守护者"),
    hero_skill("不破之人", "守护者精通；每场景首次即将降到 0 HP 时可保留 1 HP。", "坚不可摧", class_name="守护者"),
    hero_skill("风暴击", "武器大师精通；多重近战攻击只打单体时造成额外伤害。", "疾风连打", class_name="武器大师"),
    hero_skill("火山", "元素使精通；学习究极元素法术。", class_name="元素使"),
    hero_skill("强力咒语", "施法职业精通；法术造成额外伤害。", "强效法术", class_name="拟兽使/元素使/熵术士/御魂使"),
)
