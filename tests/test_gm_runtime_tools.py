...
class GMRuntimeToolTests(unittest.TestCase):
    ...
    def test_transition_scene_resolves_clear_nearby_movement_without_moving_other_pcs(self) -> None:
        ...
        self.assertEqual(self.app.scene_manager.history[-1].summary, "伊莉雅与值守望离开登记小室。")
        self.assertEqual(
    ...
    def test_start_conflict_rejects_enemy_without_combat_profile(self) -> None:
        ...
        self.assertFalse(receipt.ok)
        self.assertEqual(receipt.error_code, "COMBAT_PROFILE_REQUIRED")
        self.assertFalse(self.app.conflict_manager.state.active)
    ...
    def test_npc_turn_tool_never_takes_a_player_turn(self) -> None:
        self.app.start_scene("风铃廊伏击", SceneType.CONFLICT, participants=["伊莉雅"])
        self.app.conflict_manager.start_scene("风铃廊伏击", ["伊莉雅"])
