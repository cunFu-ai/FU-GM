...
class UltraCampaignHarness:
    ...
    def _adventure_turns(self) -> list[tuple[str, str]]:
        return [
            ("阿凛", "我们准备进入第一章，请时悠先把镜头打开到白花碑驿站。伊莉雅把碎月遗物固定在盾后，等待现场局势浮现。"),
            ("阿凛", "伊莉雅先观察驿站入口和周围道路，看看有没有被跟踪、封锁或埋伏的迹象。"),
            ("白河", "洛岚听完现场动静后，想找这里最懂钟声或晶炉的人问几句：最近有没有听见钟声迟响？"),
            ("南星", "赛璃先照看我们护送的那名灰晶病旅人，不描写病变细节；她轻声问旅人最后记得谁提过收购记忆。"),
            (
                "阿凛",
                "伊莉雅愿意消耗1点物语点补一个世界细节：白花碑驿站由赤羽遗民的白花守望会管理，他们会把每个失去的名字刻在风铃内侧。"
                "伊莉雅请求守望会提供避开财团关卡的旧路。",
            ),
            ...
            ("白河", "洛岚把钟芯和便携装置接在一起，尝试在自动机造成更大破坏前切断它的远程控制；如果这需要命刻，请由 GM 公开赌注。"),
            ...
            ("阿凛", "如果当前压力已经暂时落定，伊莉雅想提议继续护送旅人去钟鸣公国，同时把七号采掘器和灵魂中枢列为后续必须追查的目标。"),
