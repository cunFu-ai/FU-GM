...
def main() -> int:
    ...
    chapter_turns = [
        (
            "阿凛",
            "第一章开场：伊莉雅把碎月遗物固定在盾后，带队抵达白花碑驿站。"
            "我先观察驿站外有没有辉钢财团的暗记、车辙或跟踪者。",
        ),
        (
            "白河",
            "洛岚把工具铺开，询问驿站钟匠最近是否听见钟声慢一拍，同时检查灰晶病与灵魂晶炉有没有异常共鸣。",
        ),
        (
            "南星",
            "赛璃安抚一名受灰晶病影响的旅人，不描写病变细节；我问他最后记得是谁在收购病人的记忆。",
        ),
        (
            "阿凛",
            "关于这座驿站我补充一个世界细节：白花碑驿站由赤羽遗民的白花守望会管理，"
            "他们会把每个失去的名字刻在风铃内侧。伊莉雅想请守望会提供一条避开财团关卡的路线。",
        ),
        (
            "白河",
            "洛岚把钟声、晶炉与旅人的证词并在一起，想判断财团下一步会去钟鸣公国还是潮鸢群岛；"
            "如果需要检定，请先说明失败会带来什么后果。",
        ),
        (
            "南星",
            "赛璃提议由三人共同护送旅人与碎月遗物前往钟鸣公国，并请大家各说一句为何愿意同行。"
            "我们把这段同行誓言作为第一章收束。",
        ),
    ]
        ...
        lines.append(
            " | ".join(
                [
                    ...
                    f"brain={span.get('action_brain_ms', 0)}ms",
